...
<main class="content">
    ...
    <section class="equipment-category-table">
        <h2>Equipment Categories</h2>
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
            <input type="text" id="search" placeholder="Search"><button class="new-equipment-category">ADD EQUIPMENT CATEGORY</button>
        </div>
        <table>
            <thead>
            <tr>
            ...
            <tbody id="equipment-category-list">
