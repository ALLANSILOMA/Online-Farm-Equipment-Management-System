...
<aside class="sidebar">
    ...
    <ul>
        ...
        <li><a href="notifications.php"><i class="fa-solid fa-bell"></i></i> Notifications</a></li>
...
<main class="content">
    ...
    <section class="ratings-table">
        <h2>Ratings</h2>
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
            <input type="text" id="search" placeholder="Search"><button class="new-ratings">ADD RATINGS</button>
        </div>
        <table>
            <thead>
            <tr>
